...
- Name: stoic-reader.spec.js >> Visual snapshots >> quote page at desktop viewport
- Location: stoic-reader.spec.js:255:5
...
Call log:
  - Expect "toHaveScreenshot(quote-desktop.png)" with timeout 10000ms
    ...
    - generic [ref=e6]:
      ...
      - paragraph [ref=e9]:
        ...
        - link "Verse 1" [ref=e13] [cursor=pointer]:
          - /url: "#"
  - contentinfo [ref=e14]:
    - link "Data Protection Policy" [ref=e16] [cursor=pointer]:
      - /url: "#"
    - generic [ref=e17]:
      - text: Copyright © 2026
      - link "The Aurelius Fund" [ref=e18] [cursor=pointer]:
        - /url: "#"
...
```ts
  158 |     test('expanding an author section reveals its works', async ({ page }) => {
  159 |         await page.locator('#menu-open-button').click();
  160 |         // Expand Marcus Aurelius (author id=1)
  161 |         await page.locator('label[for="author-1-toggle"]').click();
  162 |         await expect(
  163 |             page.locator('#menu .menu-author-item').filter({ hasText: 'Marcus Aurelius' })
  164 |                .locator('a', { hasText: 'Meditations' })
  165 |         ).toBeVisible();
  166 |     });
  167 | 
  168 |     test('clicking Meditations in the menu opens the book', async ({ page }) => {
  169 |         await page.locator('#menu-open-button').click();
