...
- Name: stoic-reader.spec.js >> Visual snapshots >> quote page at tablet viewport
- Location: stoic-reader.spec.js:261:5
...
Call log:
  - Expect "toHaveScreenshot(quote-tablet.png)" with timeout 10000ms
